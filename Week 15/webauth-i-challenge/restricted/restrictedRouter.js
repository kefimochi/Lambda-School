...
RestrictedRouter.get("/:id/tasks", (req, res) => {
...
RestrictedRouter.post("/:id/tasks", (req, res) => {
  console.log(req.body);
...
RestrictedRouter.put("/:id", (req, res) => {
  if (!req.body.name || !req.body.completed) {
    res.status(400).json({
      errorMessage: "Please provide name and completed for the project."
    });
...
RestrictedRouter.delete("/:id", (req, res) => {
